...
const DeliveryForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!phone || !/^(\+94\s?)?\d{9,10}$/.test(phone)) newErrors.phone = "Phone Number must start with +94 and be followed by 9 to 10 digits.";
    if (!whatsappNo || !/^(\+94\s?)?\d{9,10}$/.test(whatsappNo)) newErrors.whatsappNo = "WhatsApp Number must start with +94 and be followed by 9 to 10 digits.";
            ...
            >
              <Box component="form" width="100%" noValidate autoComplete="off" onSubmit={handleSubmit}>
                ...
                <FormControl fullWidth margin="normal" variant="outlined">
                  ...
                  {errors.deliveryDistrict && <Typography color="error">{errors.deliveryDistrict}</Typography>}
                </FormControl>
                <TextField
                  fullWidth
                  margin="normal"
